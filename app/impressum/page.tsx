                ...
                <div className="space-y-16 text-neutral-800">
                    ...
                    <section>
                        ...
                        <div className="space-y-6">
                            <div>
                                <h3 className="mb-3 text-sm font-normal uppercase tracking-wider">Haftung für
                                    Inhalte</h3>
                    ...
                    <section>
                        ...
                        <div className="space-y-6 text-base font-light leading-relaxed text-justify">
                            ...
                            <h3 className="text-sm font-normal uppercase tracking-wider mt-8">1. Verantwortliche
                                Stelle</h3>
                            <p>
                            ...
                            <h3 className="text-sm font-normal uppercase tracking-wider mt-8">2. Erhebung und
                                Speicherung personenbezogener Daten</h3>
                            <p>
                                Diese Website dient ausschließlich der Präsentation unserer Arbeiten und Leistungen. Wir
                                erheben keine
                                personenbezogenen Daten, verwenden keine Cookies und keine Analysetools. Beim Besuch
                                dieser Website
                                werden automatisch technische Daten (z.&nbsp;B. Browsertyp, Betriebssystem, Uhrzeit des
                                Zugriffs)
                                verarbeitet, um die Seite anzuzeigen. Diese sogenannten Server-Logfiles werden
                                automatisch vom
                                Hosting-Anbieter erhoben und nach kurzer Zeit gelöscht.
                            </p>

                            <h3 className="text-sm font-normal uppercase tracking-wider mt-8">3. Kontaktaufnahme per
                                E-Mail</h3>
                            <p>
                            ...
                            <p>
                                ...
                                Daten, deren
                                Herkunft und Empfänger sowie den Zweck der Datenverarbeitung, sowie ein Recht auf
                                Berichtigung, Sperrung
                                oder Löschung dieser Daten. Hierzu sowie zu weiteren Fragen zum Thema Datenschutz können
                                Sie sich
                            ...
                            <p>
                                Beim Besuch der Seite werden technische Verbindungsdaten automatisch an Server unseres
                                Hosting-Anbieters
                                übermittelt. Die Verarbeitung dieser Daten erfolgt gemäß Art.&nbsp;6 Abs.&nbsp;1
                                lit.&nbsp;f DSGVO auf
                                Grundlage unseres berechtigten Interesses an einer sicheren und effizienten
